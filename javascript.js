...
Blockly.JavaScript['nao_says'] = function(block) {
    var text_name = block.getFieldValue('NAME');
    var value_nao_says = Blockly.JavaScript.valueToCode(block, 'Nao Says', Blockly.JavaScript.ORDER_ATOMIC);
    // TODO: Assemble JavaScript into code variable.
    var code = 'from naoqi import ALProxy' + '\n'
    code += 'tts = ALProxy("ALTextToSpeech", "<IP of your robot>", 9559)' +'\n'
    code += 'tts.say("Hello, world!")';
    return code;
};